...
import im.chatify.xabber.android.data.entity.AbstractAccountTable;
...
public class DatabaseManager extends SQLiteOpenHelper implements
    ...
    private static final String DATABASE_NAME = "chatify.db";
    ...
    private DatabaseManager() {
        super(CIApp.getInstance(), DATABASE_NAME, null, DATABASE_VERSION);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion > newVersion) {
            ...
            while (oldVersion < newVersion) {
                ...
                for (OnMigrationListener listener : CIApp.getInstance()
