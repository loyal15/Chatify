...
import im.chatify.xabber.android.receiver.ConnectivityReceiver;
...
public class NetworkManager implements OnCloseListener, OnInitializedListener {
    ...
    static {
        instance = new NetworkManager(CIApp.getInstance());
    ...
    private NetworkManager(CIApp application) {
    ...
    @Override
    public void onClose() {
        CIApp.getInstance().unregisterReceiver(connectivityReceiver);
    }
