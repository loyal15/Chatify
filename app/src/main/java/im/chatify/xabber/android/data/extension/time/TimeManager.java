 ...
 */
package im.chatify.xabber.android.data.extension.time;
...
import im.chatify.xabber.android.data.extension.capability.OnServerInfoReceivedListener;
import im.chatify.xabber.android.data.extension.capability.ServerInfoManager;
import im.chatify.xabber.xmpp.address.Jid;
import im.chatify.xabber.xmpp.time.Time;
...
public class TimeManager implements OnServerInfoReceivedListener,
    ...
    private void onAvailable(ConnectionItem connection) {
        for (OnTimeReceivedListener listener : CIApp.getInstance()
