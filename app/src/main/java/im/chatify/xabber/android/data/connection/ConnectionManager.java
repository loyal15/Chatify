 ...
 */
package im.chatify.xabber.android.data.connection;
...
public class ConnectionManager implements OnInitializedListener, OnCloseListener, OnTimerListener {
    ...
    static {
        ...
        ServiceDiscoveryManager.setDefaultIdentity(new DiscoverInfo.Identity("client", CIApp.getInstance()
                .getString(R.string.app_name), "handheld"));
    ...
    public void preprocessForRetrievePassword(String account) throws NetworkException, SmackException.NotConnectedException {
        ...
        connectionThread.preprocessForRetrievePassword();
    }

    public void retrievePassword(String account) throws NetworkException, SmackException.NotConnectedException {
        ...
        connectionThread.retrievePassword();
    }

    public void login(String account, String password) throws NetworkException, SmackException.NotConnectedException {
        ...
        connectionThread.login(password);
    }
    ...
    public void onConnection(ConnectionThread connectionThread) {
        ...
        for (OnConnectionListener listener : CIApp.getInstance().getManagers(OnConnectionListener.class)) {
    ...
    public void onConnected(final ConnectionThread connectionThread) {
        ...
        for (OnConnectedListener listener : CIApp.getInstance().getManagers(OnConnectedListener.class)) {
    ...
    public void onAuthorized(ConnectionThread connectionThread) {
        ...
        for (OnAuthorizedListener listener : CIApp.getInstance().getManagers(OnAuthorizedListener.class)) {
    ...
    public void onDisconnect(ConnectionThread connectionThread) {
        ...
        for (OnDisconnectListener listener : CIApp.getInstance().getManagers(OnDisconnectListener.class)) {
    ...
    public void processPacket(ConnectionThread connectionThread, Stanza stanza) {
        ...
        for (OnPacketListener listener : CIApp.getInstance().getManagers(OnPacketListener.class)) {
