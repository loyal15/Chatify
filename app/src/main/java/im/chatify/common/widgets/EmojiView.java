...
//        setBackgroundColor(0xff222222);
        ...
        tabs.setIndicatorColor(0xff009688);
        tabs.setIndicatorHeight(AndroidUtilities.dp(1.0f));
        tabs.setUnderlineHeight(AndroidUtilities.dp(1.0f));
//        tabs.setUnderlineColor(0xff009688);
//        tabs.setUnderlineColor(getResources().getColor(R.color.light_gray));
