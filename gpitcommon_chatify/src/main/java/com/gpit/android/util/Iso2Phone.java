...
public class Iso2Phone {
	...
	public static String getCountryCodeByPhonePrefix(String prefix, boolean includePlus) {
		if (prefix == null) {
			return null;
		}
		
		prefix = Utils.stripExceptNumbers(prefix, includePlus);
		
		for ( Map.Entry<String, String> entry : country2phone.entrySet() ) {
			String key = entry.getKey();
			String value = entry.getValue();
		
			value = Utils.stripExceptNumbers(value, includePlus);
	...
	public static String[] getAllPrefix() {
		return country2phone.values().toArray(new String[country2phone.values().size()]);
	}
