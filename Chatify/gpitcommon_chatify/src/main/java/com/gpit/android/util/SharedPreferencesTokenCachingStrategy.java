...
public class SharedPreferencesTokenCachingStrategy {
    ...
    public SharedPreferencesTokenCachingStrategy(Context context, String cacheKey) {
        this.cacheKey = Utils.isNullOrEmpty(cacheKey) ? DEFAULT_CACHE_KEY : cacheKey;
    ...
    public Bundle load() {
        ...
        for (String key : allCachedEntries.keySet()) {
            try {
                ...
                Log.w(TAG, "Error reading cached value for key: '" + key + "' -- " + e);
                return null;
            }
        }
    ...
    public void save(Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            try {
            	...
            	Log.w(TAG, "Error processing value for key: '" + key + "' -- " + e);
