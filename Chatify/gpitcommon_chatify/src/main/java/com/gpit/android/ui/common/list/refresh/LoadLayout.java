...
import com.gpit.android.ui.common.list.refresh.PullToRefreshBase.Mode;
...
public class LoadLayout extends FrameLayout {
	...
	public LoadLayout(Context context, AttributeSet attrs) {
		this(context, Mode.BOTH, null);
	}
	
	public LoadLayout(Context context, final Mode mode, TypedArray attrs) {
		super(context);
		
		ViewGroup header = (ViewGroup) LayoutInflater.from(context).inflate(R.layout.subview_refresh_header, this);
		if (header == null)
			return;
