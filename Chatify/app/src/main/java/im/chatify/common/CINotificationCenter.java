...
public class CINotificationCenter {
    ...
    private static volatile CINotificationCenter Instance = null;
    public static CINotificationCenter getInstance() {
        CINotificationCenter localInstance = Instance;
        if (localInstance == null) {
            synchronized (CINotificationCenter.class) {
                localInstance = Instance;
                if (localInstance == null) {
                    Instance = localInstance = new CINotificationCenter();
                }
            }
        }
