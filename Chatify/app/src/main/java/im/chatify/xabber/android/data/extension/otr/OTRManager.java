...
import im.chatify.xabber.android.data.entity.NestedMap.Entry;
...
import im.chatify.xabber.android.data.extension.ssn.SSNManager;
import im.chatify.xabber.android.data.message.AbstractChat;
import im.chatify.xabber.android.data.message.ChatAction;
import im.chatify.xabber.android.data.message.MessageManager;
import im.chatify.xabber.android.data.notification.EntityNotificationProvider;
...
public class OTRManager implements OtrEngineHost, OtrEngineListener,
    ...
    public String getReplyForUnreadableMessage(SessionID sessionID) {
        return CIApp.getInstance().getString(R.string.otr_unreadable_message);
    }
    ...
    public String getFallbackMessage(SessionID sessionID) {
        return CIApp.getInstance().getString(R.string.otr_request);
    }
