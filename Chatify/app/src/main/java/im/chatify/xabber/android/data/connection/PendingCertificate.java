...
import im.chatify.R;
import im.chatify.xabber.android.certificate.CertificateConfirmation;
import im.chatify.xabber.android.data.notification.NotificationItem;
...
public class PendingCertificate implements NotificationItem {
    ...
    public Intent getIntent() {
        return CertificateConfirmation.createIntent(CIApp.getInstance(),
                getFingerprint(), reason);
    }

    @Override
    public String getTitle() {
        return CIApp.getInstance()
