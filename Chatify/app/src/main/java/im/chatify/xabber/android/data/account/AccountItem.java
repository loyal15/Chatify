...
public class AccountItem extends ConnectionItem {
    ...
    public static final String UNDEFINED_PASSWORD = "im.chatify.xabber.android.data.core.AccountItem.UNDEFINED_PASSWORD";
    /**
    ...
    public AccountItem(AccountProtocol protocol, boolean custom, String host,
                       ...
                       ArchiveMode archiveMode, Map<String, String> attributes) {
        super(protocol, custom, host, port, serverName, userName, resource,
                storePassword, password, saslEnabled, tlsMode, compression,
                proxyType, proxyHost, proxyPort, proxyUser, proxyPassword, attributes);
        this.id = null;
