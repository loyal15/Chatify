...
public class GroupManager implements OnLoadListener, OnAccountRemovedListener,
     ...
     */
    public static final String IS_ROOM = "im.chatify.xabber.android.data.IS_ROOM";

    /**
     * Reserved group name for active chat group.
     */
    public static final String ACTIVE_CHATS = "im.chatify.xabber.android.data.ACTIVE_CHATS";

    /**
     * Reserved group name to store information about group "out of groups".
     */
    public static final String NO_GROUP = "im.chatify.xabber.android.data.NO_GROUP";

    /**
     * Group name used to store information about account itself.
     */
    public static final String IS_ACCOUNT = "im.chatify.xabber.android.data.IS_ACCOUNT";

    /**
     * Account name used to store information that don't belong to any account.
     */
    public static final String NO_ACCOUNT = "im.chatify.xabber.android.data.NO_ACCOUNT";
    ...
    public String getGroupName(String account, String group) {
        if (group == GroupManager.NO_GROUP)
            return CIApp.getInstance().getString(R.string.group_none);
        else if (group == GroupManager.IS_ROOM)
            return CIApp.getInstance().getString(R.string.group_room);
