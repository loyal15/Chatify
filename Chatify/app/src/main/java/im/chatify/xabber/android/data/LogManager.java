...
public class LogManager implements OnLoadListener {
    ...
    static {
        debugable = (CIApp.getInstance().getApplicationInfo().flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
    ...
    static {
        instance = new LogManager(CIApp.getInstance());
    ...
    private LogManager(CIApp application) {
    }
    ...
    public void onLoad() {
        if (log) {
            ...
            // "im.chatify.xabber.android.data.FileLogDebugger");
