 ...
 */
package im.chatify.xabber.android.data.extension.archive;
...
import im.chatify.xabber.android.data.account.OnAccountAddedListener;
import im.chatify.xabber.android.data.account.OnAccountArchiveModeChangedListener;
...
import im.chatify.xabber.android.data.connection.OnDisconnectListener;
...
import im.chatify.xabber.android.data.entity.NestedMap;
import im.chatify.xabber.android.data.entity.NestedNestedMaps;
import im.chatify.xabber.android.data.extension.capability.ServerInfoManager;
import im.chatify.xabber.android.data.extension.time.OnTimeReceivedListener;
import im.chatify.xabber.android.data.extension.time.TimeManager;
...
import im.chatify.xabber.android.data.notification.BaseAccountNotificationProvider;
import im.chatify.xabber.android.data.notification.NotificationManager;
import im.chatify.xabber.xmpp.address.Jid;
import im.chatify.xabber.xmpp.archive.AbstractMessage;
import im.chatify.xabber.xmpp.archive.Auto;
import im.chatify.xabber.xmpp.archive.Chat;
import im.chatify.xabber.xmpp.archive.CollectionHeader;
import im.chatify.xabber.xmpp.archive.Default;
import im.chatify.xabber.xmpp.archive.Item;
import im.chatify.xabber.xmpp.archive.ItemRemove;
import im.chatify.xabber.xmpp.archive.List;
import im.chatify.xabber.xmpp.archive.Modified;
import im.chatify.xabber.xmpp.archive.OtrMode;
import im.chatify.xabber.xmpp.archive.Pref;
import im.chatify.xabber.xmpp.archive.Retrieve;
import im.chatify.xabber.xmpp.archive.SaveMode;
import im.chatify.xabber.xmpp.archive.Session;
import im.chatify.xabber.xmpp.archive.SessionRemove;
import im.chatify.xabber.xmpp.rsm.Set;
...
public class MessageArchiveManager implements OnPacketListener,
    ...
    static {
        instance = new MessageArchiveManager(CIApp.getInstance());
    ...
    private MessageArchiveManager(CIApp application) {
    ...
    private void onModifiedAvailable(ConnectionItem connection) {
        for (OnArchiveModificationsReceivedListener listener : CIApp
    ...
    public void requestHistory(String account, String bareAddress, int newCount, int incomingCount) {
        if (AccountManager.getInstance().getArchiveMode(account) != ArchiveMode.available
