...
import im.chatify.xabber.android.data.connection.ConnectionSettings;
import im.chatify.xabber.android.data.connection.ConnectionState;
...
public class AccountManager implements OnLoadListener, OnWipeListener {
    ...
    private AccountManager() {
        this.application = CIApp.getInstance();
    ...
    private AccountItem addAccount(AccountProtocol protocol, boolean custom, String host, int port,
                                   ...
                                   KeyPair keyPair, Date lastSync, ArchiveMode archiveMode, Map<String, String> attributes,
        ...
        AccountItem accountItem = new AccountItem(protocol, custom, host, port, serverName, userName,
                ...
                proxyPassword, syncable, keyPair, lastSync, archiveMode, attributes);
    ...
    public String addAccount(String user, String password, AccountType accountType, boolean syncable,
                             boolean storePassword, boolean useOrbot, Map<String, String> attributes, boolean registerNewAccount)
        ...
        String resource = CIUtils.getXMPPResourceName(CIApp.getInstance());
...
//            host = serverName;
        ...
        ArchiveMode archiveMode = ArchiveMode.available;
        ...
        accountItem = addAccount(accountType.getProtocol(), useCustomHost, host, port, serverName, userName,
                ...
                "", "", syncable, null, null, archiveMode, attributes, registerNewAccount);
        if (accountItem == null) {
    ...
    public void updateAccount(String account, boolean custom, String host, int port, String serverName,
                              ...
                              String proxyUser, String proxyPassword, boolean syncable,
                              ArchiveMode archiveMode, int colorIndex, Map<String, String> attributes) {
        AccountItem result;
        ...
        if (accountItem.getConnectionSettings().getServerName().equals(serverName)
            ...
            result = addAccount(protocol, custom, host, port, serverName, userName, storePassword,
                    ...
                    saslEnabled, tlsMode, compression, proxyType, proxyHost, proxyPort, proxyUser,
                    proxyPassword, syncable, keyPair, lastSync, archiveMode, attributes, false);
        }
        ...
        CIApp.getInstance().runOnUiThread(new Runnable() {
            ...
            public void run() {
                for (OnAccountChangedListener accountListener
                        : CIApp.getInstance().getUIListeners(OnAccountChangedListener.class)) {
