...
import im.chatify.R;
import im.chatify.xabber.android.data.AbstractTable;
        ...
        switch (toVersion) {
            ...
            case 34:
                ...
                Editor editor = PreferenceManager.getDefaultSharedPreferences(
                        CIApp.getInstance().getBaseContext()).edit();
                if (count < 2) {
                    editor.putBoolean(CIApp.getInstance().getString(
            ...
            case 61:
                ...
                String value = PreferenceManager.getDefaultSharedPreferences(
                        CIApp.getInstance().getBaseContext()).getString(
                        "chats_history", "all");
                switch (value) {
                    case "all":
