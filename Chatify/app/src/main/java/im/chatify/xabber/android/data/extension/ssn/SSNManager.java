 ...
 */
package im.chatify.xabber.android.data.extension.ssn;
...
import im.chatify.xabber.xmpp.form.DataFormType;
import im.chatify.xabber.xmpp.ssn.DisclosureValue;
import im.chatify.xabber.xmpp.ssn.Feature;
import im.chatify.xabber.xmpp.ssn.LoggingValue;
import im.chatify.xabber.xmpp.ssn.SecurityValue;
...
public class SSNManager implements OnPacketListener, OnAccountRemovedListener {
    ...
    static {
        instance = new SSNManager(CIApp.getInstance());
    ...
    private SSNManager(CIApp application) {
